const prompts = [
    ...
    "You should never give alcohol to _____",
    ...
    "Sometimes, after a long day, you just need to _____",
    ...
    "Name the sequel to 'Titanic' if there were one. 'Titanic 2: _____'",
    ...
    "If God has a sense of humor, he welcomes people to heaven by saying, _____",
    ...
    "People wouldn't respect He-Man as much if, to gain his power, he held up his sword and shouted _____",
    "Fun thing to do if locked in the mall overnight",
    "The worst person to receive a sponge bath from",
    "Pants would be a whole lot better if they _____",
    "The most awesome Guinness World Record to break",
    "A little-known way to get gum out of your hair",
    "It's bad to be buried alive. It's worse to be buried alive with _____.",
    "Something that would not work as well as skis",
    "A rejected title for 'The Good, The Bad and the Ugly' was 'The Good, the Bad and the _____'",
    "A rejected name for a ship in the U.S. Naval Fleet: the USS _____",
    "What to say to get out of jury duty",
    "What the Statue of Liberty is hiding beneath that robe",
    "There's only one time that murder is acceptable and that is when _____",
    ...
    "Little-known fact: A secret area in the White House is the _____ room",
    ...
    "A faster way to get home from the Land of Oz is to click your heels three times and say _____.",
    ...
    "Finish this sentence: When I'm rich, my mansion will have a room called The _____ Room.",
    ...
    "A bad place for your rocket ship to crash would be The Planet of the _____",
    ...
    "A gift nobody would want: The _____ of the Month Club",
    "A just-so-crazy-it's-brilliant business idea to pitch on 'Shark Tank'",
    "A terrifying fortune cookie fortune",
    "It would be scary to read on a food package, May contain trace elements of _____.",
    "What a dog sext message might say",
    "Something the devil is afraid of",
    "CBS should air a TV show about lawyers who are also _____",
    ...
    "Tomorrow's news headline: Scientists Are Shocked to Discover That _____",
    ...
    "It never ends well when you mix _____ and _____",
    "The best reason to go to Australia",
    "The beauty pageant no one wants to see: Miss _____",
    "The perfect meal would be a _____ stuffed in a _____ stuffed in a _____",
    ...
    "You should never _____ and _____ at the same time",
    ...
    "Tip: Never eat at a place called Kentucky Fried _____",
    "Something overheard at the Last Supper",
    "The name of a species of dinosaur you wouldn't want to meet",
    "The worst way to fly: _____ Airlines",
    "So... what was that movie 'Birdman' about anyway?",
    "Little-known fact: Over the course of a lifetime, an average person accidentally eats ten _____",
    ...
    "Advice: Never stick your tongue into _____",
    ...
    "The worst pizza is _____-style pizza",
    "What to do when your parachute fails",
    "Sleepwalking can be a problem but it's not as bad as sleep_____",
    "A good name for a dog country singer",
    "Little-known fact: the fourth Wise Man gave baby Jesus the worst gift of all: _____",
    ...
    "This just in! A _____ has won the election and will become the new governor of Texas.",
    ...
    "A terrible food truck would be one that goes around selling only _____",
    ...
    "Life would be so much better if we all lived in _____",
    ...
    "The worst children's board game would be _____, _____ Hippos",
